...
$(".seekBar").rangeinput();
$(".handle").addClass("rounded");
$(".slider").addClass("rounded");
...
*****************************************************/
    ...
    var myobject = '<object class="playerpreview" id="myFlash" type="application/x-shockwave-flash" data="http://storynory.com/wp-content/themes/storynory/js/player_mp3_js.swf" width="1" height="1"><param name="movie" value="http://storynory.com/wp-content/themes/storynory/js/player_mp3_js.swf" /><param name="AllowScriptAccess" value="always" /><param name="FlashVars" value="listener=myListener&amp;interval=500" /></object>';
