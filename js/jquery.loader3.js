       ...
       // flashObject: $("#myFlash")[0],
        ...
        play: function(mp3, flash) {
            ...
            if (myListener.position === 0) {
                flashing.SetVariable("method:setUrl", flashy.mp3);
            }

            flashing.SetVariable("method:play", "");
            flashing.SetVariable("enabled", "true");
        ...
        pause: function() {
            flashing.SetVariable("method:pause", "");
            $("a.playPause").removeClass("pause");
            $("a.playPause").addClass("play");
        },
        ...
        stop: function() {
            flashing.SetVariable("method:stop", "");
        },
        ...
        scrubAudio: function(value) {
            ...
            flashing.SetVariable("method:setPosition", newtime);

        },

        setPosition: function() {
            var position = document.getElementById("inputPosition").value;
            flashing.SetVariable("method:setPosition", position);
        }
